...
class EmailShareFrontendContractTests(unittest.TestCase):
    ...
    def test_share_page_contains_read_only_shell(self):
        ...
        self.assertIn('<title>非凡的多邮箱管理系统</title>', index_template)
        self.assertIn('<span class="navbar-brand-title">非凡的多邮箱管理系统</span>', index_layout)
        ...
        self.assertNotIn('github-link', template)
        self.assertNotIn('insertGithubLink', share_js)
        self.assertNotIn('.github-link', share_css)
